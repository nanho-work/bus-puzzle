...
namespace BusPuzzle
{
    public static class Localization
    {
        ...
        private static readonly string[] Rows =
        {
            ...
            "daily_reward_title|DAILY REWARD|매일 보상|毎日報酬|每日奖励|每日獎勵|รางวัลรายวัน|Quà hằng ngày|Hadiah harian|RECOMPENSA DIARIA|RECOMPENSA DIÁRIA|TÄGLICHE BELOHNUNG|RÉCOMPENSE DU JOUR",
            "daily_reward_message|Today's reward is ready.|오늘의 보상이 준비됐어요.|今日の報酬を受け取れます。|今日奖励已准备好。|今日獎勵已準備好。|รางวัลวันนี้พร้อมแล้ว|Quà hôm nay đã sẵn sàng.|Hadiah hari ini siap.|Tu recompensa está lista.|Sua recompensa está pronta.|Deine Belohnung ist bereit.|La récompense est prête.",
            "daily_reward_gold|+{0} Gold|+{0} 골드|+{0} ゴールド|+{0} 金币|+{0} 金幣|+{0} ทอง|+{0} vàng|+{0} emas|+{0} oro|+{0} ouro|+{0} Gold|+{0} or",
            "daily_reward_skip_ticket|Skip Ticket x{0}|스킵권 x{0}|スキップ券 x{0}|跳过券 x{0}|跳過券 x{0}|ตั๋วข้าม x{0}|Vé bỏ qua x{0}|Tiket lewati x{0}|Ticket x{0}|Ticket x{0}|Skip-Ticket x{0}|Ticket x{0}",
            "daily_reward_claim|Claim|받기|受け取る|领取|領取|รับ|Nhận|Klaim|Reclamar|Receber|Abholen|Recevoir",
            "daily_reward_claimed|Claimed|수령 완료|受け取り済み|已领取|已領取|รับแล้ว|Đã nhận|Diklaim|Reclamado|Recebido|Erhalten|Reçu",
            "daily_reward_claimed_message|Today's reward has been claimed.|오늘 보상은 이미 받았어요.|今日の報酬は受け取り済みです。|今日奖励已领取。|今日獎勵已領取。|รับรางวัลวันนี้แล้ว|Đã nhận quà hôm nay.|Hadiah hari ini sudah diklaim.|La recompensa de hoy ya se reclamó.|A recompensa de hoje já foi recebida.|Die heutige Belohnung wurde abgeholt.|La récompense du jour a été reçue.",
            "daily_challenge_title|DAILY CHALLENGE|일일도전|デイリーチャレンジ|每日挑战|每日挑戰|ชาเลนจ์รายวัน|Thử thách hằng ngày|Tantangan harian|DESAFÍO DIARIO|DESAFIO DIÁRIO|TÄGLICHE HERAUSFORDERUNG|DÉFI DU JOUR",
            "daily_challenge_message|Clear each challenge, then claim its reward.|도전을 클리어한 뒤 보상을 받아요.|チャレンジをクリアして報酬を受け取ろう。|完成挑战后领取奖励。|完成挑戰後領取獎勵。|ผ่านชาเลนจ์แล้วรับรางวัล|Vượt thử thách rồi nhận thưởng.|Selesaikan tantangan lalu klaim hadiah.|Completa cada desafío y reclama la recompensa.|Conclua cada desafio e receba a recompensa.|Schließe Aufgaben ab und hole die Belohnung.|Terminez chaque défi puis recevez la récompense.",
            "daily_challenge_step_1|Step 1  Easy|1단계  쉬움|ステップ1  かんたん|第1步  简单|第1步  簡單|ขั้น 1 ง่าย|Bước 1  Dễ|Langkah 1  Mudah|Paso 1  Fácil|Etapa 1  Fácil|Schritt 1  Leicht|Étape 1  Facile",
            "daily_challenge_step_2|Step 2  Focus|2단계  집중|ステップ2  集中|第2步  专注|第2步  專注|ขั้น 2 โฟกัส|Bước 2  Tập trung|Langkah 2  Fokus|Paso 2  Enfoque|Etapa 2  Foco|Schritt 2  Fokus|Étape 2  Concentration",
            "daily_challenge_step_3|Step 3  Hard|3단계  어려움|ステップ3  むずかしい|第3步  困难|第3步  困難|ขั้น 3 ยาก|Bước 3  Khó|Langkah 3  Sulit|Paso 3  Difícil|Etapa 3  Difícil|Schritt 3  Schwer|Étape 3  Difficile",
            "daily_challenge_step_detail|Cars {0} · Colors {1} · Units {2}x|차량 {0} · 색상 {1} · 유닛 {2}명씩|車両 {0} · 色 {1} · ユニット {2}人|车辆 {0} · 颜色 {1} · 单位 {2}人|車輛 {0} · 顏色 {1} · 單位 {2}人|รถ {0} · สี {1} · ชุดละ {2}|Xe {0} · Màu {1} · Nhóm {2}|Mobil {0} · Warna {1} · Unit {2}|Coches {0} · Colores {1} · Unidad {2}|Carros {0} · Cores {1} · Unidade {2}|Autos {0} · Farben {1} · Einheiten {2}|Voitures {0} · Couleurs {1} · Unités {2}",
            "daily_challenge_start|Challenge|도전하기|挑戦|挑战|挑戰|ท้าทาย|Thử thách|Tantang|Desafiar|Desafiar|Starten|Défier",
            "daily_challenge_claim_reward|Claim Reward|보상받기|報酬を受け取る|领取奖励|領取獎勵|รับรางวัล|Nhận thưởng|Klaim hadiah|Reclamar recompensa|Receber recompensa|Belohnung holen|Recevoir",
            "daily_challenge_reward_gold_skip|+{0} Gold / Skip x{1}|+{0} 골드 / 스킵권 x{1}|+{0} ゴールド / スキップ x{1}|+{0} 金币 / 跳过券 x{1}|+{0} 金幣 / 跳過券 x{1}|+{0} ทอง / ตั๋ว x{1}|+{0} vàng / Vé x{1}|+{0} emas / Tiket x{1}|+{0} oro / Ticket x{1}|+{0} ouro / Ticket x{1}|+{0} Gold / Ticket x{1}|+{0} or / Ticket x{1}",
            "daily_challenge_stage_label|Daily {0}|일일 {0}단계|デイリー {0}|每日 {0}|每日 {0}|รายวัน {0}|Ngày {0}|Harian {0}|Diario {0}|Diário {0}|Täglich {0}|Jour {0}",
            "daily_challenge_loading|Entering challenge|일일도전 입장 중|チャレンジに入場中|正在进入挑战|正在進入挑戰|กำลังเข้าสู่ชาเลนจ์|Đang vào thử thách|Memasuki tantangan|Entrando al desafío|Entrando no desafio|Challenge wird geladen|Entrée dans le défi",
            "stage_loading|Preparing stage|스테이지 준비 중|ステージ準備中|正在准备关卡|正在準備關卡|กำลังเตรียมด่าน|Đang chuẩn bị màn|Menyiapkan stage|Preparando nivel|Preparando fase|Level wird vorbereitet|Préparation du niveau",
            "daily_challenge_return|Return|돌아가기|戻る|返回|返回|กลับ|Quay lại|Kembali|Volver|Voltar|Zurück|Retour",
            "daily_challenge_coming_soon|Challenge map will be connected next.|도전 맵은 다음 패치에서 연결됩니다.|チャレンジマップは次のパッチで接続します。|挑战地图将在下次补丁连接。|挑戰地圖將在下次補丁連接。|แผนที่ชาเลนจ์จะเชื่อมในแพตช์ถัดไป|Bản đồ thử thách sẽ được nối ở bản vá tiếp theo.|Map tantangan akan disambungkan pada patch berikutnya.|El mapa del desafío se conectará en el próximo parche.|O mapa do desafio será ligado no próximo patch.|Die Challenge-Karte folgt im nächsten Patch.|La carte de défi sera connectée au prochain patch.",
            "daily_challenge_clear|Challenge Clear|도전 클리어|チャレンジクリア|挑战完成|挑戰完成|ชาเลนจ์สำเร็จ|Hoàn thành thử thách|Tantangan selesai|Desafío completado|Desafio concluído|Challenge geschafft|Défi réussi",
            "daily_challenge_refreshed|Challenge refreshed|도전이 갱신됐어요|チャレンジが更新されました|挑战已刷新|挑戰已刷新|ชาเลนจ์รีเฟรชแล้ว|Thử thách đã làm mới|Tantangan diperbarui|Desafío actualizado|Desafio atualizado|Challenge aktualisiert|Défi actualisé",
            ...
            "ad_skip_ticket_button|Skip {0}|스킵권 {0}|スキップ {0}|跳过券 {0}|跳過券 {0}|ตั๋วข้าม {0}|Vé bỏ qua {0}|Tiket lewati {0}|Saltar {0}|Pular {0}|Skip {0}|Passer {0}",
            "ad_skip_ticket_none|No Ticket|스킵권 없음|チケットなし|无跳过券|無跳過券|ไม่มีตั๋ว|Không có vé|Tidak ada tiket|Sin ticket|Sem ticket|Kein Ticket|Aucun ticket",
            "ad_skip_ticket_stop|Use Skip Ticket?\\n+1 Stop ({0})|스킵권을 사용할까요?\\n+1 정류장 ({0})|スキップチケットを使いますか？\\n+1 停留所 ({0})|使用跳过券？\\n+1 站位 ({0})|使用跳過券？\\n+1 站位 ({0})|ใช้ตั๋วข้ามไหม?\\n+1 จุดจอด ({0})|Dùng vé bỏ qua?\\n+1 điểm dừng ({0})|Pakai tiket lewati?\\n+1 halte ({0})|¿Usar ticket?\\n+1 parada ({0})|Usar ticket?\\n+1 parada ({0})|Skip-Ticket nutzen?\\n+1 Halteplatz ({0})|Utiliser un ticket ?\\n+1 arrêt ({0})",
            ...
            "station_unlock_gold|Buy +1 Stop?\\nGold {0}/{1}|+1 정류장을 구매할까요?\\n골드 {0}/{1}|停留所を+1購入しますか？\\nゴールド {0}/{1}|购买+1站位？\\n金币 {0}/{1}|購買+1站位？\\n金幣 {0}/{1}|ซื้อจุดจอด +1?\\nทอง {0}/{1}|Mua +1 điểm dừng?\\nVàng {0}/{1}|Beli +1 halte?\\nEmas {0}/{1}|¿Comprar +1 parada?\\nOro {0}/{1}|Comprar +1 parada?\\nOuro {0}/{1}|+1 Halteplatz kaufen?\\nGold {0}/{1}|Acheter +1 arrêt ?\\nOr {0}/{1}",
            ...
            "nickname_short|Nickname|닉네임|名前|昵称|暱稱|ชื่อ|Tên|Nama|Nombre|Nome|Name|Nom",
            "nickname_title|NICKNAME|닉네임|名前|昵称|暱稱|ชื่อ|Tên|NAMA|NOMBRE|NOME|NAME|NOM",
            "nickname_placeholder|Enter nickname|닉네임 입력|名前を入力|输入昵称|輸入暱稱|ใส่ชื่อ|Nhập tên|Masukkan nama|Escribe nombre|Digite o nome|Name eingeben|Saisir le nom",
            "nickname_initial_hint|Choose a nickname for ranking|랭킹에 표시할 닉네임을 정해주세요|ランキング表示名を決めてください|选择排行显示名|選擇排行顯示名|เลือกชื่อสำหรับอันดับ|Chọn tên hiển thị|Pilih nama peringkat|Elige nombre para ranking|Escolha nome do ranking|Namen für Rangliste wählen|Choisissez un nom",
            "nickname_hint|6-16 width, no emoji|6~16폭, 이모지 불가|6〜16幅、絵文字不可|6-16宽度，不能用表情|6-16寬度，不能用表情|กว้าง 6-16 ไม่มีอีโมจิ|Rộng 6-16, không emoji|Lebar 6-16, tanpa emoji|Ancho 6-16, sin emoji|Largura 6-16, sem emoji|Breite 6-16, keine Emoji|Largeur 6-16, sans emoji",
            "nickname_save|Save|저장|保存|保存|儲存|บันทึก|Lưu|Simpan|Guardar|Salvar|Speichern|Enregistrer",
            "nickname_saved|Saved|저장 완료|保存しました|已保存|已儲存|บันทึกแล้ว|Đã lưu|Tersimpan|Guardado|Salvo|Gespeichert|Enregistré",
            "nickname_error_empty|Enter a nickname|닉네임을 입력해주세요|名前を入力してください|请输入昵称|請輸入暱稱|ใส่ชื่อก่อน|Nhập tên trước|Masukkan nama|Escribe un nombre|Digite um nome|Bitte Namen eingeben|Saisissez un nom",
            "nickname_error_unsupported|Unsupported character|사용할 수 없는 문자가 있어요|使えない文字があります|包含不可用字符|包含不可用字元|มีอักขระที่ใช้ไม่ได้|Có ký tự không hỗ trợ|Ada karakter tak didukung|Caracter no admitido|Caractere não aceito|Nicht unterstütztes Zeichen|Caractère non pris en charge",
            "nickname_error_emoji|Emoji cannot be used|이모지/지원하지 않는 문자는 사용할 수 없어요|絵文字は使えません|不能使用表情|不能使用表情|ใช้อีโมจิไม่ได้|Không dùng emoji|Emoji tidak bisa dipakai|No se permiten emoji|Emoji não permitido|Emoji nicht erlaubt|Emoji interdit",
            "nickname_error_min_width|Use Korean 3+ letters or English 6+|한글은 3자 이상, 영어/숫자는 6자 이상 입력해주세요|韓国語は3文字以上、英数字は6文字以上|韩文至少3字，英文/数字至少6字|韓文至少3字，英文/數字至少6字|เกาหลี 3 ตัวขึ้นไป อังกฤษ/ตัวเลข 6 ตัวขึ้นไป|Tiếng Hàn 3+ ký tự, chữ/số 6+|Korea 3+ huruf, Inggris/angka 6+|Coreano 3+ letras, inglés/números 6+|Coreano 3+ letras, inglês/números 6+|Koreanisch 3+ Zeichen, Englisch/Zahlen 6+|Coréen 3+ caractères, anglais/chiffres 6+",
            "nickname_error_max_width|Use 16 display width or less|표시 폭 16 이하로 입력해주세요|表示幅16以下で入力|显示宽度需为16以内|顯示寬度需為16以內|ใช้ความกว้างไม่เกิน 16|Dùng độ rộng tối đa 16|Gunakan lebar maks 16|Usa ancho máximo 16|Use largura máxima 16|Maximal Breite 16|Largeur maximale 16",
            "nickname_error_width|Use 6-16 display width|표시 폭 6~16으로 입력해주세요|表示幅6〜16で入力|显示宽度需为6-16|顯示寬度需為6-16|ใช้ความกว้าง 6-16|Dùng độ rộng 6-16|Gunakan lebar 6-16|Usa ancho 6-16|Use largura 6-16|Breite 6-16 verwenden|Utilisez largeur 6-16",
            "leaderboard_short|Rank|랭킹|ランキング|排行|排行|อันดับ|Hạng|Peringkat|Ranking|Ranking|Rang|Rang",
            "leaderboard_title|RANKING|랭킹|ランキング|排行榜|排行榜|อันดับ|Xếp hạng|PERINGKAT|CLASIFICACIÓN|RANKING|RANGLISTE|CLASSEMENT",
            "leaderboard_refresh|Refresh|새로고침|更新|刷新|重新整理|รีเฟรช|Làm mới|Segarkan|Actualizar|Atualizar|Aktualisieren|Actualiser",
            "leaderboard_loading|Loading ranking|랭킹 불러오는 중|ランキング読み込み中|正在加载排行|正在載入排行|กำลังโหลดอันดับ|Đang tải xếp hạng|Memuat peringkat|Cargando ranking|Carregando ranking|Rangliste lädt|Chargement du classement",
            "leaderboard_empty|No records yet|아직 기록이 없어요|まだ記録がありません|暂无记录|尚無紀錄|ยังไม่มีสถิติ|Chưa có kỷ lục|Belum ada catatan|Sin registros|Sem registros|Noch keine Einträge|Aucun record",
            "leaderboard_error|Could not load ranking|랭킹을 불러오지 못했어요|ランキングを読み込めません|无法加载排行|無法載入排行|โหลดอันดับไม่ได้|Không tải được xếp hạng|Gagal memuat peringkat|No se pudo cargar|Não foi possível carregar|Rangliste konnte nicht geladen werden|Impossible de charger",
            "leaderboard_my_best|My best Stage {0:00}|내 최고 스테이지 {0:00}|自己ベスト Stage {0:00}|我的最佳关卡 {0:00}|我的最佳關卡 {0:00}|ด่านสูงสุด {0:00}|Màn tốt nhất {0:00}|Stage terbaik {0:00}|Mi mejor nivel {0:00}|Melhor fase {0:00}|Bestes Level {0:00}|Meilleur niveau {0:00}",
            "leaderboard_no_personal_record|Clear a stage to join|스테이지를 클리어하면 등록돼요|ステージクリアで参加|通关后即可上榜|通關後即可上榜|ผ่านด่านเพื่อเข้าร่วม|Qua màn để tham gia|Selesaikan stage untuk ikut|Supera un nivel para entrar|Conclua uma fase para entrar|Schließe ein Level ab|Terminez un niveau",
            "leaderboard_column_rank|Rank|순위|順位|排名|排名|อันดับ|Hạng|Rank|Rango|Rank|Rang|Rang",
            "leaderboard_column_nickname|Nickname|닉네임|名前|昵称|暱稱|ชื่อ|Tên|Nama|Nombre|Nome|Name|Nom",
            "leaderboard_column_stage|Stage|스테이지|Stage|关卡|關卡|ด่าน|Màn|Stage|Nivel|Fase|Level|Niveau",
            "leaderboard_header|Rank  Nickname  Stage|순위  닉네임  스테이지|順位  名前  Stage|排名  昵称  关卡|排名  暱稱  關卡|อันดับ  ชื่อ  ด่าน|Hạng  Tên  Màn|Rank  Nama  Stage|Rango  Nombre  Nivel|Rank  Nome  Fase|Rang  Name  Level|Rang  Nom  Niveau",
            "leaderboard_row|#{0}  {1}  Stage {2:00}|#{0}  {1}  스테이지 {2:00}|#{0}  {1}  Stage {2:00}|#{0}  {1}  第 {2:00} 关|#{0}  {1}  第 {2:00} 關|#{0}  {1}  ด่าน {2:00}|#{0}  {1}  Màn {2:00}|#{0}  {1}  Stage {2:00}|#{0}  {1}  Nivel {2:00}|#{0}  {1}  Fase {2:00}|#{0}  {1}  Level {2:00}|#{0}  {1}  Niveau {2:00}",
