...
namespace BusPuzzle
{
    public static class Localization
    {
        ...
        private static readonly string[] Rows =
        {
            ...
            "feedback_subject|Bus Puzzle Feedback|버스 퍼즐 피드백|Bus Puzzle フィードバック|Bus Puzzle 反馈|Bus Puzzle 回饋|ข้อเสนอแนะ Bus Puzzle|Góp ý Bus Puzzle|Masukan Bus Puzzle|Comentarios de Bus Puzzle|Feedback do Bus Puzzle|Bus Puzzle Feedback|Retour Bus Puzzle",
